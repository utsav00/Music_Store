                        ...
                        <div class="row right_player_content">
                            ...
                            <div class="col-xs-2 volume">
                                <div class="row volume" >
                                    <input type="image" id="unmute" src="Image/unmute.png" name="playlist" width="35px" height="35px" style="display: none;">             
                                </div>
                                <div class="row volume" >
                                    <input type="image" id="mute" src="Image/mute.png" name="playlist" width="35px" height="35px" >             
                                </div>
                            </div>
